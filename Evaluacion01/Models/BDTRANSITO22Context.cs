...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("server=DARWIN\\SQLEXPRESS;database=BDTRANSITO22;integrated security=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Papeleta>(entity =>
            {
                ...
                entity.HasOne(d => d.CodinfNavigation)
                    ...
                    .HasConstraintName("FK__PAPELETAS__CODIN__45F365D3");

                entity.HasOne(d => d.CodpolNavigation)
                    .WithMany(p => p.Papeleta)
                    .HasForeignKey(d => d.Codpol)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__PAPELETAS__CODPO__46E78A0C");

                entity.HasOne(d => d.NroplaNavigation)
                    .WithMany(p => p.Papeleta)
                    .HasForeignKey(d => d.Nropla)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__PAPELETAS__NROPL__44FF419A");
            });
            ...
            modelBuilder.Entity<Vehiculo>(entity =>
            {
                ...
                entity.HasOne(d => d.DniproNavigation)
                    ...
                    .HasConstraintName("FK__VEHICULOS__DNIPR__3B75D760");
            });
